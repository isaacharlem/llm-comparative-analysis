...
- `model_comparison.py` is derived from code originally developed at the UChicago Data Science Institute by Isaac Harlem and is licensed under the BSD 3-Clause License (see [LICENSE-BSD](LICENSE-BSD)).
